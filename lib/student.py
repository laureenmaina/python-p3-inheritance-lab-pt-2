...
class ChattyStudent(Student):
    ...
    def raise_hand(self):
     ...
     for _ in range(10):      #The _ is a convention in Python to indicate that the loop variable is not going to be used. It’s just a placeholder to run the loop the specified number of times.
            super().raise_hand()